...
VARIABLE_DICT = {
    ...
    "Epi(1-cos(pi))" : {
        "name":"Epi_cospi",
        "title":"Coherence",
        "binning": PlotConfig.LacknerBinning,
    ...
    "Print Arachne":
    {
        ...
        "title":"run_subrun",
        "binning":[0,1,2],
       # "value_getter": lambda event: TruthTools.PrintArachne_for_nimmy(event) or 1,
...
#    "Number of Side Exiting Muon":
#    {
#        "name" : "Number of Side Exiitng Muon",
#        "title": "Number of Side Exiitng Muon",
#        "binning":[ i for i in range(0,11)],
#        "value_getter" : lambda event: Utilities.GetNumberofMuonsExiting(event),
#    },
...
PLOT_SETTINGS= {
    ...
    "Eavail_for_muons":
    {
        "name" : "Eavail_for_muons",
        "title" : "Eavail_for_muons; Eavail_for_muons (GeV); dNEvents/dE_{Eavail_for_muons}",
        "binning" : [PlotConfig.MUON_ENERGY_BINNING],
        "value_getter" : [lambda event: TruthTools.Eavail_for_muons(event)],
        "tags": reco_tags
    },
    ...
    "RecoWeighted_Epi(1-cos(pi))" : {
        "name":"RecoWeighted_Epi_cospi",
        "title":"Coherence; E_{#pi}(1-cos(#theta_{#pi})) (GeV); Eel(GeV)",
        "binning": [[0.005* i for i in range(0,61)],
    ...
    "Lackner Truth" : {
        ...
        "title":"Coherence; E_{#pi}(1-cos(#theta_{#pi})) (GeV); NEvents",
        "binning": [[0.005* i for i in range(0,61)]],
        "value_getter": [lambda event: TruthTools.LacknerVariable(event)],
        "tags": truth_tags
    },
    "True Signal Lackner" : {
        "name":"lackner_true_signal",
        "title":"Coherence; E_{#pi}(1-cos(#theta_{#pi})) (GeV); NEvents",
        "binning": [[0.005* i for i in range(0,61)]],
        "value_getter": [lambda event: TruthTools.LacknerVariable(event)],
        "tags": truth_signal_tags
    ...
    "Lackner Ratio" : {
        "name":"lackner_ratio",
        "title":"Lackner Ratio; Lackner Reco/Truth - 1; NEvents",
        "binning": [[round((0.05*i)-1,2) for i in range(0,61)]],
        "value_getter": [lambda event: TruthTools.LacknerRatio(event)],
        "tags": truth_tags
    },
    "Lackner Migration":
    {
        "name" : "lackner_migration",
        "title" : "Lackner Migration; Reco Lackner (GeV); True Lackner (GeV)",
        "binning" : [[0.005* i for i in range(0,61)],
                     [0.005* i for i in range(0,61)]],
        "value_getter" : [lambda event: event.kin_cal.reco_E_lep*(1-event.kin_cal.reco_cos_theta_lep),lambda event: TruthTools.LacknerVariable(event)],
        "tags":resolution_tags,
    },
    "IUE vs Lackner Reco":
    {
        "name" : "iue_vs_L_reco",
        "title" : "IUE vs Lackner Reco; IUE(MeV); Reco Lackner (GeV)",
        "binning" : [PlotConfig.INLINE_UPSTREAM_ENERGY_BINS,
                     [0.005* i for i in range(0,61)]],
        "value_getter" : [lambda event: event.UpstreamInlineEnergy, lambda event: event.kin_cal.reco_E_lep*(1-event.kin_cal.reco_cos_theta_lep)],
        "tags":resolution_tags,
    },
    "t vs Lackner Truth":
    {
        "name" : "t_vs_L_truth",
        "title" : "t vs Lackner Truth; IUE(MeV); Truth Lackner (GeV)",
        "binning" : [PlotConfig.T_BINS,
                     [0.005* i for i in range(0,61)]],
        "value_getter" : [lambda event: TruthTools.tDef1(event), lambda event:TruthTools.LacknerVariable(event)],
        "tags":resolution_tags,
    },
    "Lackner Ratio Migration":
    {
        "name" : "lackner_ratio_migration",
        "title" : "Lackner Ratio Migration; Reco Lackner (GeV); Lackner Reco/True-1",
        "binning" : [[0.005* i for i in range(0,61)],
                     [round((0.05*i)-1,2) for i in range(0,61)]],
        "value_getter" : [lambda event: event.kin_cal.reco_E_lep*(1-event.kin_cal.reco_cos_theta_lep),lambda event: TruthTools.LacknerVariable(event)],
        "tags":migration_tags,
    },
    "Vertex Z" : {
...
################Jeremy comparison plots ###########################
     ...
     "Upstream Energy":
    {
     ...
     "Number of Side Exiting Muon":
    {
        "name": "Number of Side Exiting Muon",
        "title" : "Number of Side Exiting Muon",
        "binning" : [PlotConfig.NUMBER_OF_EXITING_MUON_BINNING],
        "value_getter" : [lambda event: TruthTools.GetNumberofMuonsExiting(event)],
        "tags" : reco_tags,
    },           #N added
...
################## 2D Reco Plots: ##################################
    ...
    {
        "name": "IUE_vs_IUE_wtd_pos",
        "title" : "IUE_vs_IUE_wtd_pos; In-line energy weight position (rad. lengths); IUE (GeV)",
        "binning": [PlotConfig.INLINE_W_BINNING,
                    PlotConfig.UPSTREAM_INLINE_ENERGY_BINS],
        "value_getter" :[ lambda event: event.UpstreamInlineEnergyWgtdPosMean,
    ...
    {
        "name" : "ee_vs_pionE",
        "title" : "Coherent Electron Energy vs Pion Energy; Electron Energy; Pion Energy",
        "binning" : [PlotConfig.ELECTRON_ENERGY_BINNING, PlotConfig.ELECTRON_ENERGY_BINNING_VS],
        "value_getter" : [lambda event: event.kin_cal.reco_E_lep, lambda event: TruthTools.PiZeroE_Coh(event)],
        "tags" :truth_tags
    },
    ...
    "True Signal Pi Zero Energy_diff_bin" : {
        "name":"true_pizeroE_newbin",
        "title": "Pi Zero Energy;  PiZero E (GeV); dNEvents/dE_PiZeroE",
        "binning": [PlotConfig.ELECTRON_ENERGY_BINNING_NEW],
        "value_getter" : [lambda event: TruthTools.PiZeroE(event)],
        "tags": truth_signal_tags
    },
    "tDef1":
    ...
    "PiZero E Diffractive": {
     ...
     "PiZero E NCCoherent": {
        "name":"PiZeroE_NCCoherent",
        "title": "Coherent Pi Zero Energy;  PiZero E (GeV); dNEvents/dE_PiZeroE",
        "binning": [PlotConfig.PION_ENERGY_BINNING],
        "value_getter" : [lambda event: TruthTools.PiZeroE_Coh(event)],
        "tags": truth_tags
    },

    "PiZero E NC_Coherent_diff_bin": {
        "name":"PiZeroE_NCCoherent_diff_bin",
        "title": "Coherent Pi Zero Energy;  PiZero E (GeV); dNEvents/dE_PiZeroE",
        "binning": [PlotConfig.ELECTRON_ENERGY_BINNING_NEW],
        "value_getter" : [lambda event: TruthTools.PiZeroE_Coh(event)],
        "tags": truth_tags
    ...
    {
        "name" : "Eel_vs_trueEel",
        "title" : "Lepton Energy vs true_Elep; Reco E (GeV); True E (GeV)",
        "binning" : [PlotConfig.NEUTRINO_ENERGY_BINNING,
                     PlotConfig.NEUTRINO_ENERGY_BINNING],
        "value_getter" : [lambda event: event.kin_cal.reco_E_lep,lambda event: event.kin_cal.true_E_lep],
        "tags":truth_tags,
    ...
    {
        "name" : "Eel_vs_pionE",
        "title" : "Lepton Energy vs pionE; Reco E (GeV); True E (GeV)",
        "binning" : [PlotConfig.ELECTRON_ENERGY_BINNING,
                     PlotConfig.ELECTRON_ENERGY_BINNING],
        "value_getter" : [lambda event: event.kin_cal.reco_E_lep,lambda event: TruthTools.PiZeroE_Coh(event)],
        "tags":truth_tags,
    ...
    {
        "name" : "ee_vs_pionE_new",
        "title" : "Coherent Electron Energy vs Pion Energy New; Electron Energy; Pion Energy",
        "binning" : [PlotConfig.ELECTRON_ENERGY_BINNING_NEW, PlotConfig.ELECTRON_ENERGY_BINNING_NEW],
        "value_getter" : [lambda event: event.kin_cal.reco_E_lep, lambda event: TruthTools.PiZeroE_Coh(event)],
        "tags" :truth_tags
    },
    "LeptonE vs pionE New":
    {
        "name" : "leptonE_vs_pionE_new",
        "title" : "Coherent Electron Energy vs Pion Energy New; Electron Energy; Pion Energy",
        "binning" : [PlotConfig.ELECTRON_ENERGY_BINNING_NEW, PlotConfig.ELECTRON_ENERGY_BINNING_NEW],
        "value_getter" : [lambda event: event.kin_cal.reco_E_lep, lambda event: TruthTools.PiZeroE(event)],
        "tags" :truth_tags
    },
    
    "LeptonE vs pionE":
    {
        "name" : "leptonE_vs_pionE",
        "title" : "Coherent Electron Energy vs Pion Energy New; Electron Energy; Pion Energy",
        "binning" : [PlotConfig.ELECTRON_ENERGY_BINNING, PlotConfig.ELECTRON_ENERGY_BINNING],
        "value_getter" : [lambda event: event.kin_cal.reco_E_lep, lambda event: TruthTools.PiZeroE(event)],
        "tags" :truth_tags
    ...
    "Reco vs True PionE":
    {
        "name": "Reco_vs_true_Pi0_energy",
        "title" : "Pi0 Kinematics; Pi0_E; reco_E",
        "binning": [PlotConfig.ELECTRON_ENERGY_BINNING_NEW,
                    PlotConfig.ELECTRON_ENERGY_BINNING_NEW],
        "value_getter" : [ lambda event:(event.mc_FSPartE[idx]/1e3 
                          if (idx := TruthTools.MostEnergeticParticle(event, 111)) is not None else None),
                        lambda event: event.kin_cal.reco_E_lep],
        #"value_getter" : [ lambda event: event.mc_FSPartE[TruthTools.MostEnergeticParticle(event,111)]/1e3,
        #                  lambda event: event.kin_cal.reco_E_lep],
        "tags" : truth_tags,
    ...
    {
        "name": "Reco_vs_True_Pion_Theta",
        "title" : "Pi0 Kinematics: theta; Pi0_theta(degree); reco_theta(degree)",
        "binning": [PlotConfig.ELECTRON_ANGLE_BINNING,
                    PlotConfig.ELECTRON_ANGLE_BINNING],
        "value_getter" :[ lambda event: TruthTools.FindThetaFromIndex(event,TruthTools.MostEnergeticParticle(event,111)),
                          lambda event: event.kin_cal.reco_theta_lep],
        "tags" : truth_tags,
    },
    ...
    {   
        "name": "True_Pi0_theta",
        "title" : "Pi0 Kinematics: theta; Pi0_theta(degree)",                   
        "binning": [PlotConfig.ELECTRON_ANGLE_BINNING],
        "value_getter" :[lambda event: TruthTools.FindThetaFromIndex(event,TruthTools.MostEnergeticParticle(event,111))],
        "tags" : truth_tags, 
    },
    ...
    {
        "name": "Reco_Lep_theta",
        "title" : "Pi0 Kinematics: theta; reco_theta(degree)",
        "binning": [PlotConfig.ELECTRON_ANGLE_BINNING],
        "value_getter" :[lambda event: event.kin_cal.reco_theta_lep],
        "tags" : truth_tags, 
    },
    ...
    {
        "name": "Epi_cospi_vs_Eel_vs_IUE",
        "title" : "Lackner Variable; E_{#pi}(1-cos(#theta_{#pi})) (GeV); Reconstructed Cone Energy (GeV) ;Inline Upstream Energy(MeV)" ,
        "binning": [PlotConfig.LacknerBinning,#[0.005* i for i in range(0,61)], 
                     PlotConfig.ELECTRON_ENERGY_BINNING,
                     PlotConfig.INLINE_UPSTREAM_ENERGY_BINS],
        "value_getter" : [lambda event: event.kin_cal.reco_E_lep*(1-event.kin_cal.reco_cos_theta_lep),
                          lambda event: event.kin_cal.reco_E_lep,
                          lambda event: event.UpstreamInlineEnergy], 
        "tags" : reco_tags,
    ...
    {
        "name": "True_Epi_cospi_vs_Epi_vs_t",
        "title" : "True Lackner Variable; E_{#pi}(1-cos(#theta_{#pi})) (GeV); Pion Energy (GeV) ;|t|(MeV)",
        "binning": [PlotConfig.LacknerBinning,#[0.005* i for i in range(0,61)],
                    PlotConfig.ELECTRON_ENERGY_BINNING,
                    PlotConfig.T_BINS],
        "value_getter" :[ lambda event: TruthTools.LacknerVariable(event),
