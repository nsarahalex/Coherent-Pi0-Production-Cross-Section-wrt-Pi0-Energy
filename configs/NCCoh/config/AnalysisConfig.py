...
BLUEARC = "/exp/minerva/data/users/{}/nu_e2".format(os.environ["USER"])
GIRDOUTPUT ="/pnfs/minerva/persistent/"


#SIDEBANDS=["Coherent","Electron_Neutrino","Pi0","Old_Pi0"] #nimmycommentedout
SIDEBANDS=["Diffractive","Electron_Neutrino","Pi0","Pi0_muonexits"]
